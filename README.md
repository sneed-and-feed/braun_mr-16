...
[![Verification: 100% PASS](https://img.shields.io/badge/Verification-100%25%20PASS%20(43%2F43%20C%2B%2B%20%7C%20100%2F100%20Web)-24FF6A?style=for-the-badge&logo=checkmarx)](VERIFICATION_CHECKLIST.md)
[![Version: 1.0.4](https://img.shields.io/badge/Version-1.0.4-EE592B?style=for-the-badge)](https://github.com/sneed-and-feed/braun_mr-16/releases/tag/v1.0.4)
...
### 2.2 Distributable Release Packages (v1.0.4)
 
Pre-compiled binary packages and checksum manifests are staged in `dist/` and published under [GitHub Releases v1.0.4](https://github.com/sneed-and-feed/braun_mr-16/releases/tag/v1.0.4):
 
| Platform | Format | Architecture | Distribution Package Archive | Verification Manifest |
|:---|:---|:---|:---|:---|
| **Windows** | Standalone (.exe) | x86_64 | [`BRAUN_MR16_v1.0.4_Standalone_Win64.zip`](dist/windows/BRAUN_MR16_v1.0.4_Standalone_Win64.zip) | `dist/SHA256SUMS.txt` |
| **Windows** | VST3 Plugin | x86_64 | [`BRAUN_MR16_v1.0.4_VST3_Win64.zip`](dist/windows/BRAUN_MR16_v1.0.4_VST3_Win64.zip) | `dist/SHA256SUMS.txt` |
| **Windows** | CLAP Plugin | x86_64 | [`BRAUN_MR16_v1.0.4_CLAP_Win64.zip`](dist/windows/BRAUN_MR16_v1.0.4_CLAP_Win64.zip) | `dist/SHA256SUMS.txt` |
| **macOS** | Universal (AU, VST3, CLAP, App) | arm64 + x86_64 | [`BRAUN_MR16_v1.0.4_macOS_Universal.zip`](https://github.com/sneed-and-feed/braun_mr-16/releases/download/v1.0.4/BRAUN_MR16_v1.0.4_macOS_Universal.zip) | `SHA256SUMS.txt` |
| **Linux** | Standalone, VST3, CLAP | x86_64 | [`BRAUN_MR16_v1.0.4_Linux_x64.tar.gz`](https://github.com/sneed-and-feed/braun_mr-16/releases/download/v1.0.4/BRAUN_MR16_v1.0.4_Linux_x64.tar.gz) | `SHA256SUMS.txt` |
| **Web** | Zero-Install Showcase | Cross-Platform | [`BRAUN_MR16_v1.0.4_Web_Showcase.zip`](dist/web/BRAUN_MR16_v1.0.4_Web_Showcase.zip) | `dist/SHA256SUMS.txt` |
...
The script builds missing release targets, executes the 34 headless DSP tests, generates Standalone, VST3, CLAP, and Web Showcase zip archives into `dist/`, and writes the cryptographic manifest `dist/SHA256SUMS.txt`.
