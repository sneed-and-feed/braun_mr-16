...
[![Verification: 100% PASS](https://img.shields.io/badge/Verification-100%25%20PASS%20(47%2F47%20C%2B%2B%20%7C%20100%2F100%20Web)-24FF6A?style=for-the-badge&logo=checkmarx)](VERIFICATION_CHECKLIST.md)
[![Version: 1.0.8](https://img.shields.io/badge/Version-1.0.8-EE592B?style=for-the-badge)](https://github.com/sneed-and-feed/braun_mr-16/releases/tag/v1.0.8)
...
### 2.2 Distributable Release Packages (v1.0.8)
 
Pre-compiled binary packages and checksum manifests are staged in `dist/` and published under [GitHub Releases v1.0.8](https://github.com/sneed-and-feed/braun_mr-16/releases/tag/v1.0.8):
 
| Platform | Format | Architecture | Distribution Package Archive | Verification Manifest |
|:---|:---|:---|:---|:---|
| **Windows** | Standalone (.exe) | x86_64 | [`BRAUN_MR16_v1.0.8_Standalone_Win64.zip`](https://github.com/sneed-and-feed/braun_mr-16/releases/download/v1.0.8/BRAUN_MR16_v1.0.8_Standalone_Win64.zip) | `dist/SHA256SUMS.txt` |
| **Windows** | VST3 Plugin | x86_64 | [`BRAUN_MR16_v1.0.8_VST3_Win64.zip`](https://github.com/sneed-and-feed/braun_mr-16/releases/download/v1.0.8/BRAUN_MR16_v1.0.8_VST3_Win64.zip) | `dist/SHA256SUMS.txt` |
| **Windows** | CLAP Plugin | x86_64 | [`BRAUN_MR16_v1.0.8_CLAP_Win64.zip`](https://github.com/sneed-and-feed/braun_mr-16/releases/download/v1.0.8/BRAUN_MR16_v1.0.8_CLAP_Win64.zip) | `dist/SHA256SUMS.txt` |
| **macOS** | Universal (AU, VST3, CLAP, App) | arm64 + x86_64 | [`BRAUN_MR16_v1.0.8_macOS_Universal.zip`](https://github.com/sneed-and-feed/braun_mr-16/releases/download/v1.0.8/BRAUN_MR16_v1.0.8_macOS_Universal.zip) | `SHA256SUMS.txt` |
| **Linux** | Standalone, VST3, CLAP | x86_64 | [`BRAUN_MR16_v1.0.8_Linux_x64.tar.gz`](https://github.com/sneed-and-feed/braun_mr-16/releases/download/v1.0.8/BRAUN_MR16_v1.0.8_Linux_x64.tar.gz) | `SHA256SUMS.txt` |
| **Web** | Zero-Install Showcase | Cross-Platform | [`BRAUN_MR16_v1.0.8_Web_Showcase.zip`](https://github.com/sneed-and-feed/braun_mr-16/releases/download/v1.0.8/BRAUN_MR16_v1.0.8_Web_Showcase.zip) | `dist/SHA256SUMS.txt` |
